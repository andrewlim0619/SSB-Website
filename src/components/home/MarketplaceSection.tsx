...
export default function MarketplaceSection() {
  return (
    <section className="relative py-16 md:py-20 overflow-hidden">
      ...
      {/* Teal gradient — very faded */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "linear-gradient(to right, rgba(0,168,150,0.15) 0%, rgba(0,168,150,0.08) 45%, rgba(0,168,150,0.02) 70%, rgba(0,168,150,0.00) 100%)",
        }}
      />
      ...
      <div className="relative z-10 container-pad">
        <FadeUp className="max-w-lg">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-navy mb-3 leading-snug">
