...
export default function JasaBogaCTA() {
  return (
    <section className="relative py-20 overflow-hidden bg-navy">
      ...
      <div
        ...
        style={{ background: "linear-gradient(to right, rgba(27,58,107,0.95) 0%, rgba(27,58,107,0.7) 100%)" }}
      />

      <div className="relative z-10 container-pad text-center">
        <p className="text-xs font-bold text-teal uppercase tracking-widest mb-3">Mulai Sekarang</p>
