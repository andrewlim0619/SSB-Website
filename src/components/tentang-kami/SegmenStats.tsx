...
const segments = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.6} d="M18 8h1a4 4 0 010 8h-1M2 8h16v9a4 4 0 01-4 4H6a4 4 0 01-4-4V8zM6 1v3M10 1v3M14 1v3" />
      </svg>
    ),
  },
  {
...
export default function SegmenStats() {
  return (
    <>
      {/* Segmen Industri */}
      <section className="py-16 bg-blue-50">
        <div className="container-pad">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <FadeUp>
              <span className="text-xs font-bold text-teal uppercase tracking-widest block mb-2">Segmen Kami</span>
              <h2 className="text-2xl md:text-3xl font-bold text-navy leading-tight">
                Melayani Berbagai<br />Segmen Industri
              </h2>
              <p className="text-sm text-gray-500 mt-3 leading-relaxed">
                Kami melayani berbagai pelanggan di Indonesia, mulai dari hotel, restoran, kafe, retail, distributor, hingga industri makanan.
              </p>
            </FadeUp>

            <FadeUp delay={80} className="md:col-span-2">
              <div className="grid grid-cols-3 sm:grid-cols-3 gap-4">
                {segments.map((s) => (
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-navy leading-tight">{s.label}</span>
                  </div>
                ))}
              </div>
            </FadeUp>
