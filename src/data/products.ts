...
export const ALL_PRODUCTS: ProductData[] = [
  ...
  // ── SAUS (alphabetical) ──────────────────────────────────────────────────
  {
    ...
    specs: {
      ...
      ukuranTray: "-",
      isiPerKarton: "24 jar",
      ukuranKarton: "42,9 x 27,6 x 10,3 cm",
  ...
  // ── CEMILAN ─────────────────────────────────────────────────────────────
  {
    ...
    nameId: "Kulit Ikan Renyah Telur Asin",
    category: "cemilan",
    categoryLabel: "Cemilan",
    description:
      "Kulit ikan pilihan yang diproses hingga menghasilkan tekstur renyah yang sempurna, dibalut bumbu telur asin yang gurih dan creamy. Camilan premium dengan cita rasa autentik yang cocok untuk semua kalangan.",
    ...
    specs: {
      ...
      ukuranTray: "-",
      isiPerKarton: "6 bag",
      ukuranKarton: "39 x 26 x 24,5 cm",
